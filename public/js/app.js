...
/* harmony import */ var _books__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./books */ "./resources/js/books.js");
/* harmony import */ var _categories__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./categories */ "./resources/js/categories.js");
/* harmony import */ var _staff__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./staff */ "./resources/js/staff.js");
...
$('#register-form').on('submit', function (event) {
  ...
  (0,_requests_js__WEBPACK_IMPORTED_MODULE_0__.request)('/api/register', 'POST', $(this));
});
...
$('#books-create').on('submit', function (e) {
  e.preventDefault();
  (0,_requests_js__WEBPACK_IMPORTED_MODULE_0__.request)('/api/books', 'POST', $(this), true, true);
});
...
$('body').on('click', '#books-delete', function (e) {
  ...
  (0,_requests_js__WEBPACK_IMPORTED_MODULE_0__.request)('/api/books/' + id, 'DELETE');
});
...
$('#categories-create').on('submit', function (e) {
  e.preventDefault();
  (0,_requests_js__WEBPACK_IMPORTED_MODULE_0__.request)('/api/categories', 'POST', $(this), true);
});
...
$('body').on('click', '#categories-delete', function (e) {
  e.preventDefault();
  var id = $(this).attr('attr-id');
  (0,_requests_js__WEBPACK_IMPORTED_MODULE_0__.request)('/api/categories/' + id, 'DELETE');
});
